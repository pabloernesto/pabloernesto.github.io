...
---
*This is part of a series on data analysis. See [part one]({% post_url 2021-12-11-dndsci-1 %}). This is my independent work. For my thoughts after seeing the solution, see here (to be written). Code available in [my github](https://github.com/pabloernesto/dndsci).*
